export const fileValidator = (files: { size: any; type: any; }[], config: { allowedFileFormats: any; fileSizeMBLimit: any; filesLimit: any; }) => {
...
export const preventBrowserDefaults = (e: DragEvent) => {
    e.preventDefault();
    e.stopPropagation();
};